...
export async function connect({ host = '127.0.0.1', port = 25565, username = 'dsh_agent', version = '1.20.4' } = {}) {
  ...
  if (dir !== null) {
    ...
    // Say so. Recording off is the default and silence about it means a player
    // finishes a run, goes looking for the video, and finds that none was ever
    // being made -- with nothing anywhere having mentioned it was possible.
    note('not recording -- set MC_RECORD_DIR to a folder to film this run')
  }
  return observe()
}
